      ...
      <section className="relative h-screen">
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            <h1 className="mb-6 text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight font-extrabold leading-tight">
              우리 가족의 삶을 설계하는<br />
              집, 하우두홈
            </h1>
            <p className="mb-10 text-base sm:text-xl md:text-2xl text-white/90 max-w-5xl mx-auto font-normal leading-relaxed">
              30년 경력의 대표가 설계부터 시공, A/S까지 책임지는 프리미엄 원스톱 건축 솔루션
            </p>
            <Link
              to="/support/consultation"
              className="inline-flex items-center gap-2 bg-white text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-gray-100 transition-colors font-semibold text-sm sm:text-base"
            >
              건축 상담 받기
              <ArrowRight size={20} />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="mt-8">
              <Link
                to="/support/consultation"
                className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-gray-800 transition-colors font-semibold text-sm sm:text-base"
              >
                인테리어 상담 받기
                <ArrowRight size={20} />
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 rounded-[20px] border border-gray-200 p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              {/* 오른쪽 영상 영역 */}
              <div className="aspect-video bg-gray-200 rounded-[20px] overflow-hidden">
                <iframe
